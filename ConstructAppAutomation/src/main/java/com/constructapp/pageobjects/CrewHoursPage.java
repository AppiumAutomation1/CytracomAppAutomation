...
public class CrewHoursPage extends DriverUtilities {
	...
	public static By btnOverTime2 = MobileBy.AccessibilityId("AI_overTime2");
	public static By btnOverTime1 = MobileBy.AccessibilityId("AI_OverTime1");
	public static By btnRegular = MobileBy.AccessibilityId("AI_regularEntry");
